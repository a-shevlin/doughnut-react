	...
	return (
		<React.Fragment>
			<section class="flex items-center justify-center py-20 bg-gray-700 min-w-screen">
				<div class="px-16 bg-grayB rounded-lg">
							...
							<div class="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
								<div class="flex items-center justify-center">
									...
									<div class="flex flex-col items-start justify-center">
										<h4 class="font-bold text-gray-100">John Doe</h4>
										<p class="text-gray-600">CEO of Something</p>
									</div>
								</div>
								<blockquote class="mt-8 text-lg text-gray-300">"This is a no-brainer if you want to take your business to the next level. If you are looking for the ultimate toolset, this is it!"</blockquote>
							</div>
